function checkDiscGradients(lambda)
...
costFunc = @(p) discLoss(p,genParams,discHiddenSize, ...
    genHiddenSize,discInputSize,genInputSize,X_real,noise,lambda);

[~, grad] = discLoss(discParams,genParams,discHiddenSize, ...
    genHiddenSize,discInputSize,genInputSize,X_real,noise,lambda);
numgrad = computeNumericalGradient(costFunc, discParams);
